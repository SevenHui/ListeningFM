...
#import "XQ_SQLiteTool.h"

@implementation XQ_SQLiteTool

// 单列
+ (XQ_SQLiteTool *)shareInstance {
    static XQ_SQLiteTool *dataBase = nil;
    if (dataBase == nil) {
        dataBase = [[XQ_SQLiteTool alloc] init];
        [dataBase openDB];
...
- (NSMutableArray *)selectAll{
    ...
    if (result == SQLITE_OK) {
        ...
        while (sqlite3_step(stmt) == SQLITE_ROW) {
            ...
            XQ_SmallEditorModel *model = [[XQ_SmallEditorModel alloc] init];
